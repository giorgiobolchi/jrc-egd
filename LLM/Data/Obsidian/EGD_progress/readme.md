...
### Goal
- Assign NACE categories (level 1, 2, and 3) to each EGD target (i.e., which categories are currently involved with each target).
...
### Methodology
1. Use an LLM to assign NACE categories (level 1, 2, and 3) based on the description of each target and context of Report 1. I have used *llama-3.3-70b-instruct* through GPT@JRC.
...
2. Gather the API requirements, the desired input data, adjust the file paths and model parameters, and run `LLM_network_TAsplit.ipynb`.
3. Manually format and clean the aggregated results.
4. Manually review the interlinkages.
...
- Marelli, L., Trane, M., Barbero Vignola, G., Gastaldi, C. et al., Delivering the EU Green Deal – Progress towards targets,  European Commission: Joint Research Centre, Publications Office of the European Union (2025) [https://data.europa.eu/doi/10.2760/3105205](https://data.europa.eu/doi/10.2760/3105205)
- Nilsson, M., Griggs, D. & Visbeck, M. Policy: Map the interactions between Sustainable Development Goals. _Nature_ **534**, 320–322 (2016). https://doi.org/10.1038/534320a